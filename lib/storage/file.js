  ...
  throughStream
    ...
    .once('writing', function() {
      if (options.resumable === false) {
        that.startSimpleUpload_(writableStream, metadata, reqOpts);
      } else {
        that.startResumableUpload_(writableStream, metadata, reqOpts);
      }
    })
 ...
 * @private
 */
File.prototype.startResumableUpload_ = function(stream, metadata, reqOpts) {
  metadata = metadata || {};
  reqOpts = reqOpts || {};
 ...
 * @private
 */
File.prototype.startSimpleUpload_ = function(stream, metadata, reqOpts) {
  var that = this;
  reqOpts = reqOpts || {};
